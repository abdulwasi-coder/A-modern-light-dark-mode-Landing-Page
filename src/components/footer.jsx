                ...
                <div className="  bg-linear-to-br from-emerald-300 via-teal-300 to-cyan-300 dark:bg-linear-to-l dark:from-slate-500 bg dark:via-slate-700 dark:to-slate-900  dark:text-slate-300  text-slate-600">
                    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                        ...
                        <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
                            <a className="">
                                <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5 text-slate-800 hover:text-slate-900" viewBox="0 0 24 24">
                            ...
                            <a className="ml-3 ">
                                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5 text-slate-800 hover:text-slate-900" viewBox="0 0 24 24">
                                    <rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
                                    <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
                                </svg>
                            </a>
                            <a className="ml-3">
                                <svg fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="0" className="w-5 h-5 text-slate-800 hover:text-slate-900" viewBox="0 0 24 24">
